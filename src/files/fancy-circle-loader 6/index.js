  ...
  getSettings(frameElement) {
    const setting = {
      ...
      molecule: {
        ...
        color: frameElement.dataLoaderColor,
        dotColor: frameElement.dataLoaderDotColor
      },
    };
    switch (frameElement.dataLoaderPosition) {
      case "inner-loader":
...
new World({ dataLoaderPosition: "inner-loader", dataLoaderColor: "white", dataLoaderDotColor: "white" });